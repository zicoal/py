...
dir_data = "D:\\py\\data\\initialreaction\\results\\FigS_Data\\FigS4\\%s\\motif=%s.txt"
fig_data = "D:\\py\\data\\initialreaction\\figs\\figS4\\%s"
#weibo_axis_motif
logx = False
logy = False
#Weibo
...
y_text_axis=[[-8.5,80],[-8.6,100],[-8.6,185],[-8.5,210],[-8.6,280],[-8.6,280]]
x_text_axis=[[-4.5,-11.5],[-4.5,-14],[-4.5,-26],[-4.5,-26],[-5.5,-65],[-5.5,-65]]
