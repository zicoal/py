...
dir_data = "D:\\py\\data\\initialreaction\\results\\201911\\roc\\Prediction_ROC_Simulation\\Fig%s\\Random_%s_%s\\%s.txt"
dir_data_single = "D:\\py\\data\\initialreaction\\results\\201911\\roc\\Prediction_ROC_Simulation_Single\\Fig%s\\Random_%s_%s\\%s.txt"
...
fig_dir2 = ['800','600','400', '200']
file_list = ['7']
file_list_single = ['feature1','feature2','1m','2m','3m']
lenged_auc = ['S:%.3f','T:%.3f','A:%.3f (3t)','A:%.3f (5t)','A:%.3f (7t)','All:%.3f']
fig_names = ['%s_800_%s' % (str_feature,str_data_type),'%s_600_%s' % (str_feature,str_data_type),'%s_400_%s' % (str_feature,str_data_type),'%s_200_%s' % (str_feature,str_data_type)]
