# !/usr/bin/python
# coding:utf-8
# calulate the Top relationships of cited
...
dest_file_citations=src_dir+"inter_citation_weight_all_%s_%s_cited.txt"
dest_file_citations_top=src_dir+"inter_citation_weight_top_%s_%s_%s_cited.txt"
...
while line:
       ...
       # actually it is not true
        # column 0 for cited
        # column 1 for citing
        str_discipline_cited = words[1].strip()
        str_discipline_citing = words[0].strip()
