...
fig_file = dir+"output\\Hr_level_size_max_%s.png"
...
ax1.semilogx(x, y1,'o-',label=('Layer'),color=colors[1], linewidth='2')
ax1.errorbar(x, y1, yerr=y1_error, fmt='-o',color=colors[1])
ax1.set_ylabel('Layer',size ='30')
ax1.set_title("Cascade Size (>%s) and Layer vs. $H_R$" % default_popular_size)
